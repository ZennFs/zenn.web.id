...
```bash
npx create-next-app -e https://github.com/ZennFs/zenn.web.id your-app-name
```

```bash
npx degit ZennFs/zenn.web.id your-app-name
```

Or deploy directly:

[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https://github.com/ZennFs/zenn.web.id)  
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/ZennFs/zenn.web.id)
...
🧠 Made with curiosity, love, and caffeine ☕ by [Moch Zein Fahmi Salas](https://zenn.web.id)
